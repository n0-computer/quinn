...
In this chapter, we discuss the configuration of the certificates that are **required** for a working noq connection.
...
[ClientConfig]: https://docs.rs/noq/latest/noq/struct.ClientConfig.html
[ServerCertVerifier]: https://docs.rs/rustls/latest/rustls/client/trait.ServerCertVerifier.html
[set_default_client_config]: https://docs.rs/noq/latest/noq/struct.Endpoint.html#method.set_default_client_config
